			...
			<form action="studentinsert.action" method="post" id="myForm">
				<table class="table table-striped">
					...
					<tr>
						<td>
							<div class="input-group" role="group">
								...
								required="required" placeholder="ex)홍길동"/>
					...
					<tr>
						<td>
							<div class="input-group" role="group">
								<span class="input-group-addon" id="basic-addon3">전화번호</span>
					...
					<tr>
						<td colspan="2" style="text-align: center;">
							...
							<br />
							<span style="height: 10px;">(※)는 필수입력 사항입니다.</span>
							<span id="errMsg" style="font-size: 10px; display: none;">
								필수사항을 모두 입력해야 합니다.
							</span>
						</td>
					</tr>
